...
describe("Phase 5 frontend production readiness", () => {
  ...
  it("has offline shell and synchronization support", () => { const sw=readFileSync(new URL("./sw.js",import.meta.url),"utf8"); const sync=readFileSync(new URL("./offline-sync.js",import.meta.url),"utf8"); expect(sw).toContain("/index.html"); expect(sync).toContain("flushOfflineQueue"); expect(sync).toContain("retryable"); });
});
