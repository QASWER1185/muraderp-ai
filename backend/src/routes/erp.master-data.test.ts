...
function makeService(): ErpService {
  const rows = {
    ...
    vendors: { id: 3, organization_id: TENANT_HEADERS["X-Organization-Id"], name: "Bestway", phone: "03007654321", city: "Lahore", created_at: "2026-08-20T00:00:00Z", updated_at: "2026-08-20T00:00:00Z" },
